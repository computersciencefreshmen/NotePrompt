...
const diagnosticsCopy = {
  zh: {
    ...
    configCheck: '配置检查',
    probe: '低成本调用测试',
    probeConfirm: '这会对一个已配置供应商发起一次真实模型调用，并消耗一次 AI 额度。确定继续吗？',
    config: '配置',
    keyConfigured: '已配置',
    keyMissing: '未配置',
    cached: '缓存',
  ...
  en: {
    ...
    probeConfirm: 'This makes one real call to one configured provider and consumes one AI credit. Continue?',
    config: 'Configure',
